...
const models = [
  {
    ...
    url: 'https://huggingface.co/TinyLlama/TinyLlama-1.1B-Chat-v1.0/resolve/main/model.safetensors?download=true',
    size: '1.1GB',
    format: 'safetensors',
    requirements: {
      minMemory: '4GB',
  ...
  },
  {
    ...
    url: 'https://huggingface.co/Intel/neural-chat-7b-v3-1/resolve/main/model.safetensors?download=true',
    size: '7GB',
    format: 'safetensors',
    requirements: {
      minMemory: '16GB',
